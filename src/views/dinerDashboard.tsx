    ...
    <View title="Your pizza kitchen">
      <div className="text-start py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="my-4 text-lg text-orange-200 text-start grid grid-cols-5 gap-2">
          <div className="font-semibold text-orange-300">name:</div>{" "}
          <div className="col-span-4">{user.name}</div>
          <div className="font-semibold text-orange-300">email:</div>{" "}
          <div className="col-span-4">{user.email}</div>
          <div className="font-semibold text-orange-300">role:</div>{" "}
