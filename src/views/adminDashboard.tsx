                        ...
                        return (
                          ...
                          >
                            <tr className="border-neutral-500 border-t-2">
                              <td className="text-start px-2 whitespace-nowrap text-l font-mono text-orange-700">
                                {franchise.name}
                              </td>
                              <td
                      ...
                      <tfoot>
                        <tr>
                          <td className="px-1 py-1">
                            ...
                            <button
                              type="submit"
                              className="ml-2 px-2 py-1 text-sm font-semibold rounded-lg border border-orange-700 text-orange-700 hover:border-orange-800 hover:text-orange-800"
